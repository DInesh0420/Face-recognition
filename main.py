...
print("hello there")
print(''' 
[GIVE YOUR NAME AND ROLLNO AND PRESS ENTER]
purple box are eyes
green box is face
enter Q to quit..!''')
...
while True:
    ...
    for x1,y1,w1,h1 in eye:
        ...
        imageop3=cv2.putText(imageop, str(name),(x+w//3,y+h+15),font,0.5,(125, 255, 255),2)
        cv2.imwrite(f"dataset/{name}.{id}" +"." +str(a) + ".jpg", resizeimg)
        m=0
